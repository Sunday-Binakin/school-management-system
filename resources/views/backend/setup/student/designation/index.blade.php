...
<div class="page-content">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a
                                    href="{{ route('setup.student.designation.index') }}">Setup</a></li>
                    ...
                    <div class="card-body">
                        <div id="datatable-buttons_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            ...
                            <div class="card-body">
                                ...
                                <h4 class="card-title"><strong>Designation</strong></h4>
                                ...
                                <div id="datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                    <a class="btn btn-primary btn-rounded waves-effect waves-light"
                                        ...
                                        data-bs-target="#addDesinationModal">Add Designation</a>
                                    <br>
                                    <br>
                                    <hr>
                                    <div class="row">
                                            ...
                                            <table id="datatable"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="display: none;">{{ $designation->name }}</td>
                                                        ...
                                                        <td>
                                                            <div class="btn-group me-2 mb-2 mb-sm-0">
                                                                <a href="#" data-bs-toggle="modal"
                                                                    data-bs-target="#editDesinationModal{{ $designation->id }}"
                                                                    class="btn btn-primary waves-light waves-effect"
                                                                    style="width: 70px"><i
                                                                        class="ri-edit-box-line"></i></a>
                                                                <a href="{{ route('setup.student.designation.destroy',$designation->id) }}"
                                                        ...
                                                        <!-- Edit Modal -->
                                                        @include('backend.setup.student.designation.modal.edit')
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            </table>
    ...
    <!-- Add Modal -->
    @include('backend.setup.student.designation.modal.create')
